...
import (
	...
	genutilrest "github.com/hashrs/blockchain/framework/chain-app/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/hashrs/blockchain/framework/chain-app/issues/4923
