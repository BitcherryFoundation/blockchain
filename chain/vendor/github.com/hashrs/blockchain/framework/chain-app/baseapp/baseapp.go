...
import (
	...
	"github.com/hashrs/blockchain/framework/chain-app/store"
	storetypes "github.com/hashrs/blockchain/framework/chain-app/store/types"
...
func (app *BaseApp) cacheTxContext(ctx sdk.Context, txBytes []byte) (sdk.Context, sdk.CacheMultiStore) {
	ms := ctx.MultiStore()
	// TODO: https://github.com/hashrs/blockchain/framework/chain-app/issues/2824
...
func (app *BaseApp) runTx(mode runTxMode, txBytes []byte, tx sdk.Tx) (gInfo sdk.GasInfo, result *sdk.Result, err error) {
	...
	if app.anteHandler != nil {
		...
		// Ref: https://github.com/hashrs/blockchain/framework/chain-app/issues/2772
		//
