...
```bash
go test -v --bench github.com/hashrs/blockchain/framework/chain-app/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/hashrs/blockchain/framework/chain-app/crypto/keys/mintkey
...
PASS
ok  	github.com/hashrs/blockchain/framework/chain-app/crypto/keys/mintkey	12.093s
```
