...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/hashrs/blockchain/framework/chain-app/types/errors.Wrap",
		"github.com/hashrs/blockchain/framework/chain-app/types/errors.Wrapf",
		"github.com/hashrs/blockchain/framework/chain-app/types/errors.WithType",
