...
import (
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/fail"
...
----
WALFILE=~/.hashrs/data/cs.wal/wal
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3406
...
func (cs *State) finalizeCommit(height int64) {
	...
	stateCopy, err = cs.blockExec.ApplyBlock(
		...
		block)
	if err != nil {
		cs.Logger.Error("Error on ApplyBlock. Did the application crash? Please restart hashrs", "err", err)
		err := tmos.Kill()
		if err != nil {
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 		(https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3839).
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://github.com/hashrs/spec.
	timeIotaMs := time.Duration(cs.state.ConsensusParams.Block.TimeIotaMs) * time.Millisecond
	if cs.LockedBlock != nil {
		// See the BFT time spec https://hashrs.com/docs/spec/consensus/bft-time.html
