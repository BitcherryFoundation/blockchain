...
import (
	...
	cstypes "github.com/hashrs/blockchain/core/consensus/dpos-pbft/consensus/types"
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/bits"
	tmevents "github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/events"
...
func RegisterMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&NewRoundStepMessage{}, "hashrs/NewRoundStepMessage", nil)
	cdc.RegisterConcrete(&NewValidBlockMessage{}, "hashrs/NewValidBlockMessage", nil)
	cdc.RegisterConcrete(&ProposalMessage{}, "hashrs/Proposal", nil)
	cdc.RegisterConcrete(&ProposalPOLMessage{}, "hashrs/ProposalPOL", nil)
	cdc.RegisterConcrete(&BlockPartMessage{}, "hashrs/BlockPart", nil)
	cdc.RegisterConcrete(&VoteMessage{}, "hashrs/Vote", nil)
	cdc.RegisterConcrete(&HasVoteMessage{}, "hashrs/HasVote", nil)
	cdc.RegisterConcrete(&VoteSetMaj23Message{}, "hashrs/VoteSetMaj23", nil)
	cdc.RegisterConcrete(&VoteSetBitsMessage{}, "hashrs/VoteSetBits", nil)
}
