...
import (
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/cmap"
	tmmath "github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/math"
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/rand"
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/p2p/conn"
...
func (r *Reactor) dialPeer(addr *p2p.NetAddress) error {
	...
	if !r.Switch.IsPeerPersistent(addr) && attempts > maxAttemptsToDial {
		...
		// https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3572
		r.book.MarkBad(addr)
...
func RegisterMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&pexRequestMessage{}, "hashrs/p2p/PexRequestMessage", nil)
	cdc.RegisterConcrete(&pexAddrsMessage{}, "hashrs/p2p/PexAddrsMessage", nil)
}
