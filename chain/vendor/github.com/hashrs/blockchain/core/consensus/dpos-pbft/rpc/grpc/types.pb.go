...
func init() {
	proto.RegisterType((*RequestPing)(nil), "hashrs.rpc.grpc.RequestPing")
	golang_proto.RegisterType((*RequestPing)(nil), "hashrs.rpc.grpc.RequestPing")
	proto.RegisterType((*RequestBroadcastTx)(nil), "hashrs.rpc.grpc.RequestBroadcastTx")
	golang_proto.RegisterType((*RequestBroadcastTx)(nil), "hashrs.rpc.grpc.RequestBroadcastTx")
	proto.RegisterType((*ResponsePing)(nil), "hashrs.rpc.grpc.ResponsePing")
	golang_proto.RegisterType((*ResponsePing)(nil), "hashrs.rpc.grpc.ResponsePing")
	proto.RegisterType((*ResponseBroadcastTx)(nil), "hashrs.rpc.grpc.ResponseBroadcastTx")
	golang_proto.RegisterType((*ResponseBroadcastTx)(nil), "hashrs.rpc.grpc.ResponseBroadcastTx")
}
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *RequestPing, opts ...grpc.CallOption) (*ResponsePing, error) {
	...
	err := c.cc.Invoke(ctx, "/hashrs.rpc.grpc.BroadcastAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastAPIClient) BroadcastTx(ctx context.Context, in *RequestBroadcastTx, opts ...grpc.CallOption) (*ResponseBroadcastTx, error) {
	...
	err := c.cc.Invoke(ctx, "/hashrs.rpc.grpc.BroadcastAPI/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hashrs.rpc.grpc.BroadcastAPI/Ping",
	}
...
func _BroadcastAPI_BroadcastTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hashrs.rpc.grpc.BroadcastAPI/BroadcastTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hashrs.rpc.grpc.BroadcastAPI",
