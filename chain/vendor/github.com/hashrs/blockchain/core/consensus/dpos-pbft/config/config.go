...
// Config defines the top level configuration for a HashRs node
type Config struct {
...
// DefaultConfig returns a default configuration for a HashRs node
...
// BaseConfig defines the base configuration for a HashRs node
type BaseConfig struct { //nolint: maligned
	...
	// or the name of an ABCI application compiled in with the HashRs binary
	...
	// TCP or UNIX socket address for HashRs to listen on for
...
// DefaultBaseConfig returns a default base configuration for a HashRs node
...
// TestBaseConfig returns a base configuration for testing a HashRs node
func TestBaseConfig() BaseConfig {
	cfg := DefaultBaseConfig()
	cfg.chainID = "HashRs_test"
...
// RPCConfig defines the configuration options for the HashRs RPC server
type RPCConfig struct {
	...
	// Migth be either absolute path or path related to HashRs's config directory.
	//
	// If the certificate is signed by a certificate authority,
	// the certFile should be the concatenation of the server's certificate, any intermediates,
	// and the CA's certificate.
	//
	// NOTE: both tls_cert_file and tls_key_file must be present for HashRs to create HTTPS server.
...
// P2PConfig defines the configuration options for the HashRs peer-to-peer networking layer
...
// MempoolConfig defines the configuration options for the HashRs mempool
...
// DefaultMempoolConfig returns a default configuration for the HashRs mempool
...
// TestMempoolConfig returns a configuration for testing the HashRs mempool
...
// FastSyncConfig defines the configuration for the HashRs fast sync service
...
// ConsensusConfig defines the configuration for the HashRs consensus service,
