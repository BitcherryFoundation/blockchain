...
import (
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/crypto/tmhash"
...
func RegisterEvidences(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&DuplicateVoteEvidence{}, "hashrs/DuplicateVoteEvidence", nil)
}

func RegisterMockEvidences(cdc *amino.Codec) {
	cdc.RegisterConcrete(MockEvidence{}, "hashrs/MockEvidence", nil)
	cdc.RegisterConcrete(MockRandomEvidence{}, "hashrs/MockRandomEvidence", nil)
}
...
// See https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/2590
