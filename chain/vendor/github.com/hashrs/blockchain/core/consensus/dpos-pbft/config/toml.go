...
// XXX: this func should probably be called by cmd/hashrs/commands/init.go
...
# "$HOME/.hashrs" by default, but could be changed via $TMHOME env variable
# or --home cmd flag.
