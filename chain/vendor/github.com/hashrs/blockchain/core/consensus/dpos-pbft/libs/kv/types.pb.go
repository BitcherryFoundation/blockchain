...
func init() {
	proto.RegisterType((*Pair)(nil), "hashrs.libs.kv.Pair")
	golang_proto.RegisterType((*Pair)(nil), "hashrs.libs.kv.Pair")
	proto.RegisterType((*KI64Pair)(nil), "hashrs.libs.kv.KI64Pair")
	golang_proto.RegisterType((*KI64Pair)(nil), "hashrs.libs.kv.KI64Pair")
}
