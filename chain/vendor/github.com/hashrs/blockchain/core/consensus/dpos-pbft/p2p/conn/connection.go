...
import (
	...
	flow "github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/flowrate"
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/timer"
	...
	for {
		...
		*/
		...
		case PacketPing:
			...
			// https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/1190
...
func RegisterPacket(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(PacketPing{}, "hashrs/p2p/PacketPing", nil)
	cdc.RegisterConcrete(PacketPong{}, "hashrs/p2p/PacketPong", nil)
	cdc.RegisterConcrete(PacketMsg{}, "hashrs/p2p/PacketMsg", nil)
}
