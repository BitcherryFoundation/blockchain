...
// PrivValidator defines the functionality of a local HashRs validator
// that signs votes and proposals, and never double signs.
type PrivValidator interface {
	// TODO: Extend the interface to return errors too. Issue: https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3602
