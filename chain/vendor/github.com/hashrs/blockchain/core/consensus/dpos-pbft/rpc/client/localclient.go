...
import (
	...
	nm "github.com/hashrs/blockchain/core/consensus/dpos-pbft/node"
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/rpc/core"
...
* Communication between an ABCI app and HashRs core when they
...
Note delivery is best-effort. If you don't read events fast enough, HashRs
