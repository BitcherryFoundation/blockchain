...
func RegisterWALMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(types.EventDataRoundState{}, "hashrs/wal/EventDataRoundState", nil)
	cdc.RegisterConcrete(msgInfo{}, "hashrs/wal/MsgInfo", nil)
	cdc.RegisterConcrete(timeoutInfo{}, "hashrs/wal/TimeoutInfo", nil)
	cdc.RegisterConcrete(EndHeightMessage{}, "hashrs/wal/EndHeightMessage", nil)
}
