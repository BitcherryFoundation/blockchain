...
import (
	...
	p2pconn "github.com/hashrs/blockchain/core/consensus/dpos-pbft/p2p/conn"
)
...
func (ln *unixListener) Accept() (net.Conn, error) {
	...
	// with a MAC - https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3099
