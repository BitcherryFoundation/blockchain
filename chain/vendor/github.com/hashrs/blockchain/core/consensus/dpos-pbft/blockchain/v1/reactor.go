...
import (
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/behaviour"
...
func RegisterBlockchainMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&bcBlockRequestMessage{}, "hashrs/blockchain/BlockRequest", nil)
	cdc.RegisterConcrete(&bcBlockResponseMessage{}, "hashrs/blockchain/BlockResponse", nil)
	cdc.RegisterConcrete(&bcNoBlockResponseMessage{}, "hashrs/blockchain/NoBlockResponse", nil)
	cdc.RegisterConcrete(&bcStatusResponseMessage{}, "hashrs/blockchain/StatusResponse", nil)
	cdc.RegisterConcrete(&bcStatusRequestMessage{}, "hashrs/blockchain/StatusRequest", nil)
}
