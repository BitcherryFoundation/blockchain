...
import (
	...
	"github.com/hashrs/blockchain/libs/crypto/chacha20poly1305"
	"github.com/hashrs/blockchain/libs/crypto/curve25519"
	"github.com/hashrs/blockchain/libs/crypto/hkdf"
	"github.com/hashrs/blockchain/libs/crypto/nacl/box"
	...
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/async"
)
...
// See https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3010)
...
func computeDHSecret(remPubKey, locPrivKey *[32]byte) (shrKey *[32]byte, err error) {
	...
	// related to: https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3010
	zero := new([32]byte)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/issues/3531
