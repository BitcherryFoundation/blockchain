...
import (
	...
	//auto "github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/autofile"
	dbm "github.com/hashrs/blockchain/libs/state-db/tm-db"

	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/libs/log"
	"github.com/hashrs/blockchain/core/consensus/dpos-pbft/mock"
...
func (h *Handshaker) Handshake(proxyApp proxy.AppConns) error {
	...
	h.logger.Info("Completed ABCI Handshake - HashRs and App are synced",
...
func (h *Handshaker) ReplayBlocks(
	...
	case storeBlockHeight < stateBlockHeight:
		// the state should never be ahead of the store (this is under hashrs's control)
	...
	case storeBlockHeight > stateBlockHeight+1:
		// store should be at most one ahead of the state (this is under hashrs's control)
	...
	if storeBlockHeight == stateBlockHeight {
		// HashRs ran Commit and saved the state.
...
Did you reset HashRs without resetting your application's data?`,
