...
- Update Amino names from "com.hashrs/..." to "hashrs/"
...
- `github.com/hashrs/go-keys -> github.com/hashrs/go-crypto/keys` - command and lib for generating and managing encrypted keys
