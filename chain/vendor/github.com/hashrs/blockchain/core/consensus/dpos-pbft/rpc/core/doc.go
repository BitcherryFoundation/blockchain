...
HashRs supports the following RPC protocols:

* URI over HTTP
* JSONRPC over HTTP
* JSONRPC over websockets

HashRs RPC is built using our own RPC library which contains its own set of documentation and tests.
See it here: https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/tree/master/rpc/lib
