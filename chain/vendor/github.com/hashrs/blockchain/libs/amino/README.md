...
GitHub](https://github.com/hashrs/blockchain/libs/amino/issues)!
...
* Amino:binary spec in [HashRs](
https://github.com/hashrs/blockchain/core/consensus/dpos-pbft/blob/master/docs/spec/blockchain/encoding.md)
...
amino.RegisterConcrete(MyStruct1{}, "com.hashrs/MyStruct1", nil)
amino.RegisterConcrete(MyStruct2{}, "com.hashrs/MyStruct2", nil)
...
(e.g.  prefixed by a unique entity name such as "com.hashrs/", and not
...
```
> hash := sha256("com.hashrs.consensus/MyConcreteName")
